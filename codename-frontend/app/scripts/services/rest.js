...
angular.module('codebaseFrontendApp')
  .factory('rest', ['$http', '$cookies', function($http, $cookies ) {
    ...
    var regHeaders = { headers :{'Access-Control-Allow-Headers': '*'}};
    var authHeaders = { headers :{service_key: 'webkey:' + $cookies.get('user_email'), auth_token:          $cookies.get('user_token')}};
